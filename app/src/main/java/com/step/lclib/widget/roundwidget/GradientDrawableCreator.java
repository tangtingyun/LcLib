...
public class GradientDrawableCreator {
    ...
    public static GradientDrawable create(TypedArray typedArray) throws XmlPullParserException {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.background_bl_shape) {
                gradientDrawable.setShape(typedArray.getInt(attr, 0));
                ...
                gradientDrawable.setCornerRadius(typedArray.getDimension(attr, 0));
                ...
                gradientDrawable.setGradientRadius(typedArray.getDimension(attr, 0));
                ...
                gradientDrawable.setUseLevel(typedArray.getBoolean(attr, false));
        ...
        if (typedArray.hasValue(R.styleable.background_bl_stroke_width)) {
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (stateList.size() > 0) {
                    ...
                    ColorStateList colorStateList = new ColorStateList(state, color);
                    gradientDrawable.setStroke((int) strokeWidth, colorStateList, strokeDashWidth, strokeGap);
